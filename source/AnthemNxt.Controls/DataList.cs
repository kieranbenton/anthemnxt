...
namespace AnthemNxt.Controls
{
	...
	public class DataList : ASP.DataList, IUpdatableControl, ICallbackContainerControl
	{
		...
		/// <summary>
		/// Raises the <see cref="System.Web.UI.Control.Load"/> event and registers this control with <see cref="AnthemNxt.Manager"/>.
		/// </summary>
		...
		/// <summary>
		///     Renders the control contents. <see cref="AnthemNxt.Manager"/> will determine if
