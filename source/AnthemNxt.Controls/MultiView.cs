...
{
    /// <summary>
    /// Creates an updatable control that acts as a container for a group of <see cref="View"/> controls.
    /// </summary>
    [ToolboxBitmap(typeof(ASP.MultiView))]
    public class MultiView : ASP.MultiView, IUpdatableControl
    {
        #region Unique Anthem control code

        /// <summary>
        ///     Raises the <see cref="System.Web.UI.WebControls.MultiView.ActiveViewChanged"/>
        ///     event and sets <see cref="UpdateAfterCallBack"/> to <strong>true</strong>.
        /// </summary>
