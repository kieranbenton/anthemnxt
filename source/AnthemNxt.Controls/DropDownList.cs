...
namespace AnthemNxt.Controls
{
	...
	/// </summary>
	[ToolboxBitmap(typeof(ASP.DropDownList))]
	public class DropDownList : ASP.DropDownList, IUpdatableControl, ICallbackControl
	{
		...
		public new ASP.ListItemCollection Items
		{
			get
			{
				return base.Items;
