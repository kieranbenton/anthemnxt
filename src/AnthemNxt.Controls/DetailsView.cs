...
namespace AnthemNxt.Controls
{
	...
	/// </summary>
	[ToolboxBitmap(typeof(ASP.DetailsView))]
	public class DetailsView : ASP.DetailsView,
		IUpdatableControl,
		ICallbackControl,
		ICallbackContainerControl
	{
		...
		/// <summary>
		/// Excecutes <see cref="System.Web.UI.WebControls.DataBoundControl.OnDataPropertyChanged"/>, 
