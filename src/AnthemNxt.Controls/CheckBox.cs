...
{
	/// <summary>
	/// Displays an updatable check box that allows the user to select a <strong>true</strong> or <strong>false</strong> condition. Uses callbacks if <see cref="AutoCallBack"/> is <strong>true</strong>.
	/// </summary>
	[ToolboxBitmap(typeof(ASP.CheckBox))]
	public class CheckBox : ASP.CheckBox, IUpdatableControl, ICallbackControl
	{
