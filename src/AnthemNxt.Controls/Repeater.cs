...
namespace AnthemNxt.Controls
{
	...
	/// </summary>
	[ToolboxBitmap(typeof(ASP.Repeater))]
	public class Repeater : ASP.Repeater, IUpdatableControl, ICallbackContainerControl
	{
		#region Unique Anthem control code

		/// <summary>
		///     Raises the <see cref="System.Web.UI.WebControls.Repeater.ItemCommand"/> and sets
		///     <see cref="UpdateAfterCallBack"/> to true.
		/// </summary>
