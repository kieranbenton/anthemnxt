...
<script runat="server">
    ...
    void Page_Load()
    {
        ...
        if (AnthemNxt.Manager.IsCallBack && sleep.Checked)
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        if (Page.IsValid)
        {
            buttonlabel.Text = (AnthemNxt.Manager.IsCallBack ? "[CallBack]:" : "[PostBack]:");
    ...
    protected void DropDownList1_SelectedIndexChanged(object sender, EventArgs e)
    {
        if (dropdownlist.SelectedValue == string.Empty)
            ...
            dropdownlistlabel.Text = (AnthemNxt.Manager.IsCallBack ? "[CallBack]:" : "[PostBack]:") + "You picked " + dropdownlist.SelectedValue;
    }

    protected void button2_Click(object sender, EventArgs e)
    {
        if (Page.IsValid)
            textboxlabel.Text = (AnthemNxt.Manager.IsCallBack ? "[CallBack]:" : "[PostBack]:") + "You entered " + HttpUtility.HtmlEncode(textbox.Text);
        else
            textboxlabel.Text = "";
    }
    ...
    {
        checkboxlabel.Text = (AnthemNxt.Manager.IsCallBack ? "[CallBack]:" : "[PostBack]:") + (checkbox.Checked ? "Checked" : "Not Checked");
    }

    protected void checkboxlist1_SelectedIndexChanged(object sender, EventArgs e)
    {
        StringBuilder sb = new StringBuilder();
        sb.Append((AnthemNxt.Manager.IsCallBack ? "[CallBack]:" : "[PostBack]:") + " You picked ");
    ...
    protected void radiobutton_CheckedChanged(object sender, EventArgs e)
    {
        if (radiobutton1.Checked)
            radiobuttonlabel.Text = (AnthemNxt.Manager.IsCallBack ? "[CallBack]:" : "[PostBack]:") + " You picked " + radiobutton1.Text;
        else if (radiobutton2.Checked)
            radiobuttonlabel.Text = (AnthemNxt.Manager.IsCallBack ? "[CallBack]:" : "[PostBack]:") + " You picked " + radiobutton2.Text;
        else
    ...
    {
        radiobuttonlistlabel.Text = (AnthemNxt.Manager.IsCallBack ? "[CallBack]:" : "[PostBack]:") + " You picked " + radiobuttonlist.SelectedValue;
    }

    protected void repeater_ItemCommand(object source, RepeaterCommandEventArgs e)
    {
        repeaterlabel.Text = (AnthemNxt.Manager.IsCallBack ? "[CallBack]:" : "[PostBack]:") + " You picked " + e.CommandArgument;
    }

    protected void textbox2_TextChanged(object sender, EventArgs e)
    {
        textboxlabel2.Text = (AnthemNxt.Manager.IsCallBack ? "[CallBack]:" : "[PostBack]:") + " You entered: " + HttpUtility.HtmlEncode(textbox2.Text);
    }

    protected void datalist_ItemCommand(object source, DataListCommandEventArgs e)
    {
        datalistlabel.Text = (AnthemNxt.Manager.IsCallBack ? "[CallBack]:" : "[PostBack]:") + " You picked " + e.CommandArgument;
    }
</script>
...
<asp:Content ID="Content2" runat="server" ContentPlaceHolderID="ContentPlaceHolder">
    ...
    <h1>
        Anthem Panel Demo</h1>
    <p>
        There are only two Anthem controls on this page: the AnthemNxt.Panel (blue border)
        that surrounds all the other controls, and an AnthemNxt.Button in the bottom right
        corner to demonstrate that you can embed Anthem control inside of an AnthemNxt.Panel.
        When AddCallBacks is true, the AnthemNxt.Panel will convert all of the child controls
        to use callbacks instead of postbacks. The AnthemNxt.Panel also has Pre- and PostCallBackFunctions
        defined to display a message while the callback is being processed on the server.
        Note that these are inherited by all child controls. Callbacks are generally very
        fast. You may need to turn on the server delay in order to see the message.</p>
    <asp:CheckBox ID="addCallBacks" runat="server" Text="AddCallBacks" Checked="true"
        ToolTip="If AddCallBacks is true, the AnthemNxt.Panel will convert all child ASP.NET WebControls to use callbacks." />
    ...
    <anthem:Panel ID="UpdatePanel1" runat="server" AutoUpdateAfterCallBack="true" BorderColor="#8080FF"
        BorderStyle="Solid" BorderWidth="1px" PreCallBackFunction="Anthem_PreCallBack"
        ...
        <div style="width: 49%; float: left;">
            ...
            <fieldset>
                ...
                <asp:CheckBox ID="checkbox" runat="server" Text="Check me!" OnCheckedChanged="checkbox1_CheckedChanged"
                    AutoPostBack="True" ValidationGroup="Two" />
                <asp:Label ID="checkboxlabel" runat="server" ForeColor="Red" />
            </fieldset>
            <fieldset>
                <legend>ASP:CheckBoxList</legend>
                <asp:CheckBoxList ID="checkboxlist" runat="server" AutoPostBack="True" OnSelectedIndexChanged="checkboxlist1_SelectedIndexChanged"
                    RepeatDirection="Horizontal" RepeatLayout="Flow" ValidationGroup="Three">
            ...
            <fieldset>
                ...
                <asp:DataList ID="datalist" runat="server" RepeatDirection="Horizontal" RepeatLayout="Flow"
            ...
            <fieldset>
                ...
                <asp:DropDownList ID="dropdownlist" runat="server" Width="127px" AutoPostBack="True"
                    OnSelectedIndexChanged="DropDownList1_SelectedIndexChanged" ValidationGroup="Four">
            ...
            <fieldset>
                ...
                <div style="float: left">
                    <asp:ListBox ID="listbox" runat="server" AutoPostBack="True" OnSelectedIndexChanged="listbox_SelectedIndexChanged"
                        Rows="3" SelectionMode="Multiple" ValidationGroup="Five">
                        <asp:ListItem>Red</asp:ListItem>
                        <asp:ListItem>Green</asp:ListItem>
                        <asp:ListItem>Blue</asp:ListItem>
        ...
        <div style="width: 49%; float: right">
            <fieldset>
                ...
                <asp:RadioButton ID="radiobutton1" runat="server" AutoPostBack="True" GroupName="radiobutton"
                    OnCheckedChanged="radiobutton_CheckedChanged" Text="On" ValidationGroup="Six" />
                <asp:RadioButton ID="radiobutton2" runat="server" AutoPostBack="True" GroupName="radiobutton"
                    Text="Off" OnCheckedChanged="radiobutton_CheckedChanged" ValidationGroup="Six" />
            ...
            <fieldset>
                ...
                <asp:RadioButtonList ID="radiobuttonlist" runat="server" RepeatDirection="Horizontal"
                    OnSelectedIndexChanged="radiobuttonlist_SelectedIndexChanged" AutoPostBack="True"
                    RepeatLayout="Flow" ValidationGroup="Seven">
                    <asp:ListItem>Red</asp:ListItem>
                    <asp:ListItem>Green</asp:ListItem>
                    <asp:ListItem>Blue</asp:ListItem>
                </asp:RadioButtonList>
            ...
            <fieldset>
                ...
                <p>
                    ...
                    property to false. For example, this AnthemNxt.Button will initially perform a postback.
