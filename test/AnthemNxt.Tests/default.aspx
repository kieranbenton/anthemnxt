...
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="ContentPlaceHolder">
    <h1>
        AnthemNxt.NET</h1>
    <p>
        Read an <a href="Overview.aspx">overview</a> about why Anthem exists and how it
        works.</p>
    <p>
        Anthem requires zero <a href="Configuration.aspx">configuration</a> to use but there
        is one setting you might want to add to your web.config file if you're still using
        ASP.NET 1.1.</p>
    <h2>
        Examples</h2>
    <p>
        To learn how to use Anthem, try reading the following examples in the order listed:</p>
    <ol>
        ...
        <li><a href="DynamicUserControls.aspx">Dynamically loading user controls with Anthem
            controls on them</a></li>
        <li><a href="UnhandledExceptions.aspx">What happens when an exception is not caught
            on the page?</a></li>
        ...
        <li><a href="InvokeClientSideFunctionAfterCallBack.aspx">Invoking client-side JavaScript
            functions after a call back returns</a></li>
        ...
        <li><a href="MemoryLeaksWithUpdates.aspx">Another test to see if Anthem leaks memory
            when updating controls on the page</a></li>
        ...
        <li><a href="InvokeMasterPageMethod.aspx">Invoking methods on master pages</a></li>
        <li><a href="GridView.aspx">Using grid views</a></li>
        <li><a href="MultiView.aspx">Using multi views</a></li>
        <li><a href="HiddenField.aspx">Updating hidden fields</a></li>
    </ol>
</asp:Content>
