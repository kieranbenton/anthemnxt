...
<asp:Content ContentPlaceHolderID="ContentPlaceHolder" runat="server">
    <h2>
        DataList Example #1</h2>
    <p>
        In this example, the DataList is an Anthem control, and all of the buttons (Edit,
        Update, Cancel) are also Anthem controls. By using Anthem buttons, you can set Anthem-specific
        properties such as ImageDuringCallBack. See <a href="DataList2.aspx">DataList Example
            #2</a> for an example using normal ASP.NET buttons.</p>
