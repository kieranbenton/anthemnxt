...
<script runat="server">
    void button1_Click(object sender, EventArgs e)
    {
        ...
        AnthemNxt.Manager.AddScriptForClientSideEval("alert('Bye!')");
        AnthemNxt.Manager.AddScriptForClientSideEval("window.location = 'http://anthem-dot-net.sourceforge.net/';");
    }
...
&lt;anthem:Button id="button2" runat="server" 
    ...
    OnClick="button2_Click" /&gt;</strong></code></pre>
            <li>
                <p>
                    Implement the event handler so that it calls <code>AnthemNxt.Manager.AddScriptForClientSideEval()</code>
                    or <code>Response.Redirect()</code>:</p>
<pre><code><strong>void button1_Click(object sender, EventArgs e) 
{ 
    AnthemNxt.Manager.AddScriptForClientSideEval("alert('Bye!')");
    AnthemNxt.Manager.AddScriptForClientSideEval(
