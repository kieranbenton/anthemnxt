...
<script runat="server">
    ...
    {
        AnthemNxt.Core.ScriptManager.AddScriptForClientSideEval("alert('whopped!');");
    }
...
<body>
    ...
    <div>
        ...
        is true. In this sample the anthem:Label PreUdate event handler uses AnthemNxt.Manager.AddScriptForClientSideEval
