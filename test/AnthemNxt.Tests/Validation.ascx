...
<script runat="server">
    ...
    {
        AnthemNxt.Core.Manager.AddScriptForClientSideEval("alert('Page.IsValid=" + Page.IsValid + "');");
    }

    protected void button2_Click(object sender, EventArgs e)
    {
        AnthemNxt.Manager.AddScriptForClientSideEval("alert('Page.IsValid=" + Page.IsValid + "');");
    }
    
    protected void button3_Click(object sender, EventArgs e)
    {
        this.panel.Visible = !this.panel.Visible;
        AnthemNxt.Panel p = this.panel as AnthemNxt.Panel;
        if (p != null)
